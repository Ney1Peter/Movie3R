#!/usr/bin/env python3
"""Run frozen V14.7 Lite/Full alignment on an arbitrary image cut stream."""
...
from scripts.v14_3_human_continuity_visualization import load_frame  # noqa: E402
from scripts.v14_5_true_recurrent_multicut_audit import (  # noqa: E402
...
def main() -> None:
    ...
    if not torch.cuda.is_available() or not str(args.device).startswith("cuda"):
        raise RuntimeError("V14.7 custom multi-cut inference requires CUDA")
    ...
    report = {
        "method": "V14.7 custom multi-cut Lite/Full comparison",
    ...
    report_path = args.output_dir / "v14_7_custom_multicut.json"
