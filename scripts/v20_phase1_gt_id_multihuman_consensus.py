#!/usr/bin/env python3
"""V20 Phase 1 GT-ID multi-human shared-Boundary feasibility study.
...
from scripts.v20_native_token_multihuman_probe import jsonable, tensor_numpy  # noqa: E402
...
def main() -> None:
    ...
    report = {
        "experiment": "V20 Phase 1 GT-ID Multi-Human Consensus Alignment v2",
    ...
    json_path = args.output_dir / f"v20_phase1_gtid_v2_offsets_{suffix}.json"
    markdown_path = args.output_dir / f"v20_phase1_gtid_v2_offsets_{suffix}.md"
