#!/usr/bin/env python3
"""EgoBody three-person V20 token and explicit-geometry smoke test."""
...
from scripts.v14_1_shot_aware_state_routing_probe import build_model, camera_matrix  # noqa: E402
from scripts.v20_native_token_multihuman_probe import (  # noqa: E402
    FEATURES,
    feature_cost,
    jsonable,
    person_feature,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output_dir", type=Path, default=ROOT / "output/v20_egobody_legoassemble"
    )
...
def main() -> None:
    ...
    report = {
        "experiment": "V20 EgoBody three-person feasibility probe",
    ...
    report_path = args.output_dir / "v20_egobody_three_person_probe.json"
    ...
    torch.save(
        ...
        args.output_dir / "v20_egobody_compact_tokens.pt",
    )
    print(f">> EgoBody V20 report: {report_path}", flush=True)
