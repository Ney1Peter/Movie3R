#!/usr/bin/env python3
"""Launch a demo.py-style viewer for a V14.7 custom multi-cut result."""
...
from scripts.v14_3_human_continuity_visualization import (  # noqa: E402
    camera_points,
    load_frame,
    transform_points,
)
from scripts.v14_5_true_recurrent_multicut_audit import scale_pose  # noqa: E402
...
def main() -> None:
    ...
    print(
        f">> V14.7 {args.method.upper()} viewer: http://127.0.0.1:{args.port}",
        flush=True,
    )
