...
This directory is maintained inside the Movie3R repository and preserves the
Shot3R ICLR 2027 paper sources, versioned
...
Since 2026-09-18, the canonical workspace has been
`Movie3R/paper/shot3r_iclr2027`. The former standalone location is retained as
a compatibility symlink. Its committed history is preserved separately in a
verified Git bundle outside the Movie3R working tree.
