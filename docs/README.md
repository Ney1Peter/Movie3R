...
| 文档 | 内容 |
|---|---|
| [训练](train.md) | Human3R 原版训练流程 |
| [评估](eval.md) | 模型评估方法 |
| [推理](inference.md) | 不同 backbone 的使用 |
| [环境配置](env_setup_h800_cuda124.md) | 当前服务器环境配置 |

## 代码说明

| 文档 | 内容 |
|---|---|
| [训练代码详解](train_code_explanation.md) | `src/train.py` 流程解析 |
| [Movie3R 训练代码入口](movie3r/train_code.md) | Movie3R 训练代码说明入口 |
