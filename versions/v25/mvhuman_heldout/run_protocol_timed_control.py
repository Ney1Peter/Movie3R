#!/usr/bin/env python3
"""Resumable driver for the evaluator-timed MVHuman control."""
...
RUNNER = HERE / "run_case_timed_control.py"
    ...
    if not (cache.is_file() and report.is_file()):
        commands.append(
            [
                ...
                "--control-event-index", str(args.control_event_index),
            ]
        )
...
def main() -> None:
    ...
    summary = {
        "schema_version": "Bridge3R-MVHuman-Heldout-MVH150-timed-control-summary-v1",
        "protocol_root": str(args.protocol_root),
        "control_event_index": args.control_event_index,
