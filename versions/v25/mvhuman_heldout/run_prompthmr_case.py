#!/usr/bin/env python3
"""MVH150 schema adapter for the unchanged official PromptHMR runner."""
...
from versions.v21.aist_singleperson import run_prompthmr_case as official
...
official.SCHEMA = "Bridge3R-MVHuman-PromptHMR-official-runtime-v1"
