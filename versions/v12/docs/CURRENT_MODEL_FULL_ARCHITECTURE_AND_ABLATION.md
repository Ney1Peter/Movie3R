...
> 文档日期：2026-07-23
>
> 正式版本：**Movie3R-Single V12.0**。
> 历史 V14.7 是冻结该版本的实验名称，V11.4 是其中的 shared-scale block，V14.6
> 是组件审计。
>
...
```text
versions/v12/docs/V11_4_SHORT_SHOT_METHOD_FREEZE.md
versions/v12/docs/V14_2_CANONICAL_HUMAN_MEMORY.md
versions/v12/docs/V14_4_UNIFIED_SIMILARITY_REANCHORING.md
