...
当前正式单人主线为 Movie3R-Single V12.0。本文件保留 V10-V14 历史实验编号，用于
说明 V12 的组件来源，不表示这些编号仍是并列发布版本。
...
`versions/v12/docs/V14_1_SHOT_AWARE_STATE_ROUTING.md`。

入口：

- `versions/v12/experiments/v14_1_shot_aware_state_routing_probe.py`
- `versions/v12/experiments/v14_1_multicut_state_routing_rollout.py`
- `versions/v12/experiments/v14_1_shape_memory_sweep.py`
...
完整报告见 `versions/v12/docs/V14_6_ALIGNMENT_COMPONENT_NECESSITY_AUDIT.md`。
