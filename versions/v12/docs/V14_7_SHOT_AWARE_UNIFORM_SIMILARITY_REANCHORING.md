...
历史冻结实验：`V14.7 Shot-Aware Uniform Similarity Re-anchoring`

## 1. 版本定位

V12 是当前完整单人方法的正式版本号。历史 V14.7 不是一次新的参数搜索，也没有在
V14.6 结果之后更改算法；它把此前分散在 Fixed Explicit、V16、V11.4 和 V14.6 审计
中的最终保留路径冻结下来，现在统一归入 `versions/v12/`。
...
| **V14.7** | **冻结 V12 的历史完整方法实验** |

因此，对外方法统一称为 **Movie3R-Single V12.0**；V14.7 只用于追溯旧结果。
