...
>
> Formal version: `Movie3R-Single V12.0`
>
> Legacy experiment freeze: `V14.7 Shot-Aware Uniform Similarity Re-anchoring`
>
> Release tag: `movie3r-v12-single`
>
...
this single-human release and the V13 multi-human research release are indexed
separately in `versions/README.md`.

## Current Default

Formal release identity: **Movie3R-Single V12.0**.
...
The formal standalone method is **Movie3R-Single V12.0**. Its scale block comes
from legacy experiment V11.4, its rotation correction comes from V16, and the
V14.6/V14.7 audits froze this selection. These identifiers are retained inside
`docs/` and `experiments/` for traceability; users should refer to the released
method as V12.
...
| Single release manifest | `versions/v12/manifest.json` |
| Full architecture and all ablations | `versions/v12/docs/CURRENT_MODEL_FULL_ARCHITECTURE_AND_ABLATION.md` |
| Standalone current method | `versions/v12/docs/V14_7_SHOT_AWARE_UNIFORM_SIMILARITY_REANCHORING.md` |
| Short-shot freeze record | `versions/v12/docs/V11_4_SHORT_SHOT_METHOD_FREEZE.md` |
| Component audit | `versions/v12/docs/V14_6_ALIGNMENT_COMPONENT_NECESSITY_AUDIT.md` |
| Final leakage/streaming audit | `versions/v12/docs/V14_5_FINAL_GEOMETRY_STREAMING_AUDIT.md` |
| Unified evaluator and scale ablations | `versions/v12/experiments/v14_4_unified_similarity_reanchoring_probe.py` |
| True recurrent 1/2/4/8-cut audit | `versions/v12/experiments/v14_5_true_recurrent_multicut_audit.py` |
| Recurrent 3D viewer | `versions/v12/experiments/v14_5_multicut_interactive_viewer.py` |
| Arbitrary image multi-cut demo | `versions/v12/run.py` |
| Arbitrary image multi-cut viewer | `versions/v12/viewer.py` |
...
.venv/bin/python versions/v12/experiments/v14_4_unified_similarity_reanchoring_probe.py \
  --device cuda:6 \
...
```bash
TMPDIR=output/v14_5_final_audit/tmp \
.venv/bin/python versions/v12/experiments/v14_5_true_recurrent_multicut_audit.py \
  --device cuda:5
```
...
1. `versions/v12/LATEST_MODEL.md`
2. `versions/v12/docs/V14_7_SHOT_AWARE_UNIFORM_SIMILARITY_REANCHORING.md`
3. `versions/v12/docs/CURRENT_MODEL_FULL_ARCHITECTURE_AND_ABLATION.md`
4. `versions/v12/docs/V14_6_ALIGNMENT_COMPONENT_NECESSITY_AUDIT.md`
5. `versions/v12/docs/V14_5_FINAL_GEOMETRY_STREAMING_AUDIT.md`
