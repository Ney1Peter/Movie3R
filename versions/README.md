...
| [Movie3R-Multi V13.0](v13/README.md) | V20 Phase 1/2、V13 Phase 3/4 | 多人几何已验证，automatic WHO 未通过 | GT-ID shared-Boundary 研究与身份桥审计 | `movie3r-v13-multihuman-geometry-validated` |
...
- V13.0 已验证 GT-ID 下多人几何优于可部署单人 anchor；Phase 3 的 native WHO 会接受
  catastrophic swaps，Phase 4 的 precision-first appearance WHO 又只有极低 coverage，
  因此默认仍只保留 GT-ID Oracle，不能作为可部署多人 Re-ID。
